package cn.inslee.admin.shiro.config;

import cn.inslee.admin.shiro.credential.Md5CredentialsMatcher;
import cn.inslee.admin.shiro.filter.UserFilter;
import cn.inslee.admin.shiro.filter.UserLogoutFilter;
import cn.inslee.admin.shiro.realm.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterMap.put("/druid/**", "user, perms[log:druid:list]");
        filterMap.put("/**", "user");
        //自定义过滤器
